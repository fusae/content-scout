...
export class DraftGenerator {
     ...
     * 为单条内容生成草稿
     */
    async generateDrafts(content, profile, options) {
     ...
     * 批量生成草稿
     */
    async generateBatch(contents, profile, options) {
     ...
     * 构建 prompt
     */
    buildPrompt(content, profile, _options) {
...
[
  ...
  },
  {
     ...
     * 解析 API 响应
     */
    parseResponse(response, maxLength) {
        try {
     ...
     * 截断草稿
     */
    truncateDraft(content, maxLength) {
